...
extension ContentView {
  ...
  public func getMenu() -> [MainMenu] {
    return [
      MainMenu(
        "Tasks", href: "#", selected: false, logo: false, dropdown: true,
        submenus: [
          SubMenu(label: "List tasks", href: "#ListTasks"),
          SubMenu(label: "Add task", href: "#AddTask"),
        ]),
      MainMenu(
        "Teams", href: "#", selected: false, logo: false, dropdown: true,
        submenus: [
          SubMenu(label: "List teams", href: "#ListTeams"),
          SubMenu(label: "Add team", href: "#AddTeam"),
        ]),
      MainMenu(
        "Projects", href: "#", selected: false, logo: false, dropdown: true,
        submenus: [
